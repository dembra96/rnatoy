...
parser = argparse.ArgumentParser(description='This script is used to run API command to launch Cufflinks pipeline CloudOS job with example parameters.')
...
# Workflow name
parser.add_argument("--workflow_name", "--workflow", default="Cufflinks pipeline", help="Workflow name. Change if in a custom workspace the name of workflow is different. Default: 'Cufflinks pipeline'.")
    ...
    workflow_params = [
        {
            ...
            "dataItemEmbedded":{
                ...
                "data":{
                    ...
                    "s3Prefix":"pipelines/rnatoy-data"
                }
            }
        },
        {
            ...
            "dataItemEmbedded":{
                "type":"S3File",
                "data":{
                    "name":"ggal_1_48850000_49020000.Ggal71.500bpflank.fa",
                    "s3BucketName":"lifebit-featured-datasets",
                    "s3ObjectKey":"pipelines/rnatoy-data/ggal_1_48850000_49020000.Ggal71.500bpflank.fa"
                }
            }
        },
        {
            ...
            "dataItemEmbedded":{
                "type":"S3File",
                "data":{
                    "name":"ggal_1_48850000_49020000.bed.gff",
                    "s3BucketName":"lifebit-featured-datasets",
                    "s3ObjectKey":"pipelines/rnatoy-data/ggal_1_48850000_49020000.bed.gff"
                }
            }
        }
    ]
